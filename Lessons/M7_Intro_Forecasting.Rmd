...
Class Note: This is a bad model.
...
plot(Mean_seas) # This is a rlly bad model.

#Model 2: Arithmetic mean on deseas data
# Since we still have a trend, this won't be a good model either.
...
SMA_deseas <- sma(deseasonal_allsectors_price, h=36)
plot(SMA_deseas)

# Model 6: Simple moving average on original data
# not good due to seasonality
...
# what we learned is naive and moving average are not goos approaches. So we could you the ARIMA model.
